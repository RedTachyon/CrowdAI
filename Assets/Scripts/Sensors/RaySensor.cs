...
namespace Sensors
{
    ...
    public struct RayInput
    {
        ...
        public (Vector3 StartPositionWorld, Vector3 EndPositionWorld) RayExtents(int rayIndex)
        {
            ...
            if (CastType == RayCastCType.Cast3D)
            {
    ...
    /// </summary>
    public class RaySensor : ISensor
    {
        float[] m_Observations;
        ObservationSpec m_ObservationSpec;
        string m_Name;

        RayInput m_RayPerceptionInput;
        RayCOutput m_RayPerceptionOutput;
        ...
        public RaySensor(string name, RayInput rayInput)
        {
            m_Name = name;
            ...
            m_RayPerceptionOutput = new RayCOutput();
        }

        /// <summary>
        /// The most recent raycast results.
        /// </summary>
        public RayCOutput RayPerceptionOutput
        {
        ...
        internal void SetRayPerceptionInput(RayInput rayInput)
        {
        ...
        public void Update()
        {
            ...
            {
                m_RayPerceptionOutput.RayOutputs = new RayCOutput.RayOutput[numRays];
            }
        ...
        public static RayCOutput Perceive(RayInput input)
        {
            RayCOutput output = new RayCOutput();
            output.RayOutputs = new RayCOutput.RayOutput[input.Angles.Count];
        ...
        /// <param name="rayIndex"></param>
        /// <returns></returns>
        internal static RayCOutput.RayOutput PerceiveSingleRay(
            RayInput input,
            int rayIndex
        )
        {
            ...
            var rayOutput = new RayCOutput.RayOutput
            {
                HasHit = castHit,
